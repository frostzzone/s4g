...
<CDropdownMenu>
  ...
  <!--
								...
								<CDropdownItem class="lightwhencursor" href="https://docs.scratch4web.ml/">
									<img src="/assets/docs-icon.png" alt="" width="22" height="24" class="d-inline-block align-top" /> Docs
								</CDropdownItem>
